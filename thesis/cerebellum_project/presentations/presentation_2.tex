...
\begin{document}
	...
	\begin{frame}{Motivation: intuition for universality}
		...
		\begin{block}{The Marr-Albus insight}
			\begin{itemize}
	...
	\begin{frame} {Paper I the unified model}
		...
		\begin{itemize}
			...
			\item \textbf{Optics}: provide explicit rules to morphisms
		\end{itemize}
	...
	\begin{frame}
		...
		\begin{itemize}
			...
			\item \textbf{Proposition generation}: transform $A \xrightarrow{R} B$ into a testeable sentence using BART
